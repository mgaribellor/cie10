...
var LiquidacionCxServiceService = /** @class */ (function () {
    function LiquidacionCxServiceService(http) {
        this.http = http;
        this.serviceUrl = 'https://jsonplaceholder.typicode.com/users';
    }
    LiquidacionCxServiceService.prototype.getAllArticles = function () {
        return ELEMENT_DATA;
    };
    LiquidacionCxServiceService.prototype.getRepoIssues = function (sort, order, page) {
    ...
    LiquidacionCxServiceService.prototype.search = function (query) {
        ...
        var url = 'http://xhygnusqx.siasgestioncontrol.com/public/api/iss2001';
        return this.http
            .get(url, {
            observe: 'response',
            params: {
...
var ConsultasModule = /** @class */ (function () {
    ...
    ConsultasModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_liquidacion_cx_liquidacion_cx_component__WEBPACK_IMPORTED_MODULE_3__["LiquidacionCxComponent"]]
        })
    ], ConsultasModule);
...
var LiquidacionCxComponent = /** @class */ (function () {
    function LiquidacionCxComponent(githubService, http) {
    ...
    LiquidacionCxComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.githubAutoComplete$ = this.autoCompleteControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(300), 
    ...
    LiquidacionCxComponent.prototype.ngAfterViewInit = function () {
    };
    ;
    ...
    LiquidacionCxComponent.prototype.masterToggle = function () {
        ...
        this.isAllSelected() ?
            ...
            this.dataSource.data.forEach(function (row) { return _this.selection.select(row[0]); });
    };
    ...
    LiquidacionCxComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_Service_liquidacion_cx_service_service__WEBPACK_IMPORTED_MODULE_1__["LiquidacionCxServiceService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"]])
...
module.exports = __webpack_require__(/*! C:\Users\Dev_JT\Documents\Developer\ng-ConsMedica\src\main.ts */"./src/main.ts");
