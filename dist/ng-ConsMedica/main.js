...
var LiquidacionCxServiceService = /** @class */ (function () {
    ...
    LiquidacionCxServiceService.prototype.search = function (query) {
        var url = 'http://api-laravel.net/api/iss2001';
        return this.http
            .get(url, {
            observe: 'response',
            params: {
...
var LiquidacionCxComponent = /** @class */ (function () {
    function LiquidacionCxComponent(githubService) {
    ...
    LiquidacionCxComponent.prototype.lookup = function (value) {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (results) { return results; }), 
        // catch errors
    ...
    LiquidacionCxComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.githubAutoComplete$ = this.autoCompleteControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), 
        // delay emits
